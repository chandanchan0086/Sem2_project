...
dbfile = r"C:\Users\Chandan\PycharmProjects\sem_2\database_f.db"
conn = None
...
def maill(base):
    ...
    mail.starttls()  # Transpoart layer security
    sender_mail_id = "manipaltest1234@gmail.com"
    sender_mail_pass_world = "Manipaltest@1234"
    receiver_mail_id = "chandanbr199627@gmail.com"
    message = MIMEMultipart()
    message['From'] = sender_mail_id
    message['To'] = receiver_mail_id
    message['Subject'] = "ROUTE-MAP"
    mail_content = base
    message.attach(MIMEText(mail_content, 'plain'))
    session = smtplib.SMTP('smtp.gmail.com', 587)  # use gmail with port
    session.starttls()  # enable security
    session.login(sender_mail_id, sender_mail_pass_world)  # login with mail_id and password
...
def distance(lat1, lat2, lon1, lon2):
    ...
    dist = gmaps.distance_matrix(origin, destination, mode="driving", language=None, avoid=None, units=None,
